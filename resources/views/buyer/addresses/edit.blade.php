...
<div class="container py-4" style="max-width: 760px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0 text-dark">✏️ Edit Alamat</h4>
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
        <div class="card-body p-4 p-md-5">
            <form method="POST" action="{{ route('buyer.addresses.update', $address) }}">
                ...
                {{-- Memanggil partial form dan passing data address --}}
                @include('buyer.addresses._form', ['address' => $address])
                
                <div class="mt-4 pt-3 border-top">
                    <button type="submit" class="btn btn-warning fw-bold rounded-pill px-5 py-2 shadow-sm w-100 mt-2 text-dark">
                        Perbarui Alamat ✓
                    </button>
                </div>
