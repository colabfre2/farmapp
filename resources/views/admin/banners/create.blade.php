...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold mb-0">Tambah Banner</h2>
...
<form method="POST" action="{{ route('admin.banners.store') }}" enctype="multipart/form-data">
    ...
    <div class="row">
            ...
            <div class="card mb-4 border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="cth: Promo Panen Raya Agustus" required>
                        @error('title') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <div class="form-text">Judul ini untuk referensi admin saja, tidak ditampilkan di banner.</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-text">Kosongkan jika banner tidak perlu diklik ke mana-mana.</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-text">Angka lebih kecil tampil lebih dulu di slider.</div>
                    </div>
        ...
        <div class="col-lg-5">
            <div class="card mb-4 border-0 shadow-sm">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <h3 class="card-title fw-bold">Gambar Banner <span class="text-danger">*</span></h3>
                </div>
                <div class="card-body">
                    <div id="drop-zone" class="upload-area p-3 text-center rounded-3">
                        ...
                        <div id="drop-text">
                            ...
                            <h5 class="mt-2 text-dark fw-semibold">Upload Gambar Banner</h5>
                            <p class="text-muted small mb-0">Rasio disarankan 16:5 (lebar), min. 1200px<br>Tarik & lepas atau klik untuk memilih.</p>
                        </div>
            ...
            <div class="d-grid">
                <button type="submit" class="btn btn-primary btn-lg fw-bold">Simpan Banner ✓</button>
            </div>
        </div>
    </div>
</form>
