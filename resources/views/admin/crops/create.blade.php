    ...
    <div class="row">
            ...
            <div class="card mb-4 border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Paddy Field A" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notes" class="form-control" rows="4" placeholder="Tambahkan keterangan tentang proses tanam ini...">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4 border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="date" name="planted_at" class="form-control @error('planted_at') is-invalid @enderror" value="{{ old('planted_at') }}" required>
                        @error('planted_at')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="expected_harvest_at" class="form-control @error('expected_harvest_at') is-invalid @enderror" value="{{ old('expected_harvest_at') }}" required>
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-success btn-lg fw-bold">Simpan Tanaman ✓</button>
            </div>
