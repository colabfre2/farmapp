        ...
        <div class="container">
            <a href="{{ route('buyer.home') }}" class="navbar-brand">
                <div class="d-flex align-items-center gap-2">
                    <div
                        style="width:32px;height:32px;background:#2d7a2d;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:16px;">
                        🌿
                    </div>
                    FarmApp
                </div>
            ...
            <div class="navbar-nav ms-auto d-flex align-items-center gap-3">
                ...
                <a href="{{ route('buyer.marketplace') }}"
                    class="nav-link {{ request()->routeIs('buyer.marketplace*') ? 'active' : '' }}">
                    🛒 Marketplace
                </a>
