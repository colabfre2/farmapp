<aside class="w-64 bg-slate-900 text-white min-h-screen">
    ...
    <nav class="p-4">
        ...
        <div class="mt-4">
            <button
    onclick="toggleMasterData()" class="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800">

    <svg id="masterDataIcon"
    ...
    <span>Master Data</span>
        ...
        <div id="masterDataMenu" class="ml-4 mt-2">
            ...
            class="block py-2 px-3 rounded {{ request()->routeIs('crop-types.*') ? 'bg-green-600 text-white' : 'hover:bg-slate-800'}}">Crop Types</a>

            <a href="#"
            class="block py-2 px-3 rounded {{ request()->routeIs('livestock-types.*') ? 'bg-green-600 text-white' : 'hover:bg-slate-800'}}">Livestock Types</a>
            
            <a href="#"
            class="block py-2 px-3 rounded {{ request()->routeIs('units.*') ? 'bg-green-600 text-white' : 'hover:bg-slate-800'}}">Units</a>

            <a href="#"
            class="block py-2 px-3 rounded {{ request()->routeIs('expanse-categories.*') ? 'bg-green-600 text-white' : 'hover:bg-slate-800'}}">Expanse categories</a>
        </div>
