...
<body class="antialiased">
            ...
            <div class="container-fluid">
                <a href="{{ route('admin.dashboard') }}" class="navbar-brand text-decoration-none">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="text-white fw-bold font-quicksand" style="font-size: 19px; letter-spacing: 0.5px;">ALMS</span>
                    </div>
                </a>
                ...
                <div class="collapse navbar-collapse show">
                    <ul class="navbar-nav pt-lg-2">
                        ...
                        {{-- ================= 1. BISNIS & KEUANGAN (PALING ATAS) ================= --}}
                        <div class="sidebar-heading">Bisnis & Keuangan</div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $isInventoryActive ? 'active' : '' }}" href="#inventory-menu" data-bs-toggle="collapse" aria-expanded="{{ $isInventoryActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon">📦</span>
                                <span class="nav-link-title">Inventori & Produk</span>
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isInventoryActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $isFinanceActive ? 'active' : '' }}" href="#finance-menu" data-bs-toggle="collapse" aria-expanded="{{ $isFinanceActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon">💰</span>
                                <span class="nav-link-title">Keuangan & Pesanan</span>
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isFinanceActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                        ...
                        {{-- ================= 2. OPERASIONAL (PERTANIAN & PETERNAKAN) ================= --}}
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $isPertanianActive ? 'active' : '' }}" href="#pertanian-menu" data-bs-toggle="collapse" aria-expanded="{{ $isPertanianActive ? 'true' : 'false' }}">
                                ...
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isPertanianActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $isPeternakanActive ? 'active' : '' }}" href="#peternakan-menu" data-bs-toggle="collapse" aria-expanded="{{ $isPeternakanActive ? 'true' : 'false' }}">
                                ...
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isPeternakanActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                            <div class="collapse {{ $isPeternakanActive ? 'show' : '' }}" id="peternakan-menu">
                                <ul class="navbar-nav ps-4">
                                    ...
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.livestock-movements.in.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.livestock-movements.in.index') }}"><span class="nav-link-title">⬆ Ternak Masuk</span></a></li>
                        ...
                        {{-- ================= 3. MASTER DATA (PALING BAWAH) ================= --}}
                        <div class="sidebar-heading">Master Data</div>
                        
                        @php 
                            $isProdActive = request()->routeIs('admin.categories.*', 'admin.units.*');
                            $isCropActive = request()->routeIs('admin.crop-types.*', 'admin.crop-varieties.*', 'admin.farms.*', 'admin.plant-cares.*');
                            $isLiveActive = request()->routeIs('admin.livestock-types.*', 'admin.kandangs.*', 'admin.medicines.*', 'admin.feeds.*');
                            $isFinActive = request()->routeIs('admin.expense-categories.*', 'admin.income-sources.*');
                        @endphp

                        {{-- Dropdown 1: Produk --}}
                        <li class="nav-item">
                            <a class="nav-link {{ $isProdActive ? 'active' : '' }}" href="#sub-produk" data-bs-toggle="collapse" aria-expanded="{{ $isProdActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon">📦</span>
                                <span class="nav-link-title">Produk</span>
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isProdActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                            <div class="collapse {{ $isProdActive ? 'show' : '' }}" id="sub-produk">
                                <ul class="navbar-nav ps-4">
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.categories.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.categories.index') }}">📂 Kategori Produk</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.units.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.units.index') }}">📏 Satuan Unit</a></li>
                                </ul>
                            </div>
                        </li>

                        {{-- Dropdown 2: Pertanian --}}
                        <li class="nav-item">
                            <a class="nav-link {{ $isCropActive ? 'active' : '' }}" href="#sub-pertanian" data-bs-toggle="collapse" aria-expanded="{{ $isCropActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon">🌱</span>
                                <span class="nav-link-title">Pertanian</span>
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isCropActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                            <div class="collapse {{ $isCropActive ? 'show' : '' }}" id="sub-pertanian">
                                <ul class="navbar-nav ps-4">
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.crop-types.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.crop-types.index') }}">🌱 Jenis Tanaman</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.crop-varieties.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.crop-varieties.index') }}">🌿 Varian Tanaman</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.farms.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.farms.index') }}">🚜 Data Ladang</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.plant-cares.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.plant-cares.index') }}">🧪 Master Perawatan</a></li>
                                </ul>
                            </div>
                        </li>

                        {{-- Dropdown 3: Peternakan --}}
                        <li class="nav-item">
                            <a class="nav-link {{ $isLiveActive ? 'active' : '' }}" href="#sub-peternakan" data-bs-toggle="collapse" aria-expanded="{{ $isLiveActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon">🐄</span>
                                <span class="nav-link-title">Peternakan</span>
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isLiveActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                            <div class="collapse {{ $isLiveActive ? 'show' : '' }}" id="sub-peternakan">
                                <ul class="navbar-nav ps-4">
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.livestock-types.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.livestock-types.index') }}">🐂 Jenis Ternak</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.kandangs.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.kandangs.index') }}">🏠 Data Kandang</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.medicines.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.medicines.index') }}">💊 Master Obat</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.feeds.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.feeds.index') }}">🌾 Master Pakan</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        {{-- Dropdown 4: Keuangan --}}
                        <li class="nav-item">
                            <a class="nav-link {{ $isFinActive ? 'active' : '' }}" href="#sub-keuangan" data-bs-toggle="collapse" aria-expanded="{{ $isFinActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon">💵</span>
                                <span class="nav-link-title">Keuangan</span>
                                <span class="nav-link-icon ms-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-chevron" style="transition: transform 0.3s ease; {{ $isFinActive ? 'transform: rotate(180deg)' : '' }}" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 9 12 15 18 9" /></svg>
                                </span>
                            </a>
                            <div class="collapse {{ $isFinActive ? 'show' : '' }}" id="sub-keuangan">
                                <ul class="navbar-nav ps-4">
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.expense-categories.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.expense-categories.index') }}">💸 Kategori Pengeluaran</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.income-sources.*') ? 'active fw-bold text-success' : '' }}" href="{{ route('admin.income-sources.index') }}">💵 Sumber Pemasukan</a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="page-header mt-3 mb-3">
                <div class="container-xl">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <div class="page-pretitle text-muted text-uppercase tracking-wide">ALMS Admin</div>
    ...
    {{-- ELEMEN PENAMPUNG DATA SESSION UNTUK SWEETALERT --}}
